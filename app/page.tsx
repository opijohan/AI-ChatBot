    ...
    <main className="w-screen">
      ...
      >
        <div className="flex flex-col gap-6 items-center">
          ...
          <Link href="/chatbot">
            <button className="inline-flex items-center justify-center whitespace-nowrap text-sm  ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 max-w-fit h-8 rounded-md px-4 py-1 bg-[#e94f37] font-semibold hover:bg-primary/90 text-[#0B0808]">
              Get Started
            </button>
          </Link>
          ...
          <div className="flex flex-col gap-12 items-center">
            ...
            <div className="flex md:flex-row flex-col gap-12">
              ...
              <Feature
                ...
                description="Simply ask Religion AI and it will do rest."
              />
              <Feature
                icon={<GrSecure />}
                headline="Secure"
